...
<?php foreach ($subjects as $subject) { ?>
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<a class="hover-text-decor-none" href="<?php echo base_url(); ?>Guest/subject/<?php echo $subject->getId(); ?>">
								<article id="article-1" class="border-boxed expanded no-margin padding-sm solid-border border-xs border-gray edged no-border-bottom text-center" style="height: 100px;">
									<img src="<?php echo base_url(); ?>assets/storage/subjects/<?php echo $subject->getId() ?>/icon.png" width="40" height="40"/><p name="id" class="font-times-new-roman font-sm"><?php echo $subject->getName(); ?></p>
								</article>
							</a>
						</div>
					</div>
